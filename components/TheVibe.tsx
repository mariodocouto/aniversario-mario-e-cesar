  ...
  return (
    <section id="the-vibe" className="py-20 bg-party-100">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white p-6 md:p-12 rounded-3xl shadow-2xl border-4 border-party-400 relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 mb-6 md:mb-8">
            ...
            <h3 className="text-3xl md:text-4xl font-black text-party-800 uppercase tracking-tight italic">O Rolê</h3>
          </div>
          ...
          <div className="text-gray-700 text-lg md:text-2xl leading-relaxed font-medium">
            ...
            <div className="bg-party-50 p-5 md:p-8 rounded-2xl border-2 border-party-100 shadow-inner">
               <p className="text-base md:text-xl text-gray-700 leading-snug">
                 Teremos churrasco completo, chope geladinho, água e refrigerante por nossa conta. 
                 <span className="block font-black text-party-600 mt-4 text-xl md:text-3xl uppercase tracking-tighter leading-tight">
